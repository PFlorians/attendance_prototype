<?php
    ...
    class MonthlySummaryMapper
    {
        ...
        public function getMonthlySummaryOfUser($uname, $monthAtt)
        {
            ...
            $res=[];
            $qry = "exec getMonthlySummaryOfUser @ulogin = ?, @monthAtt=?, @errMsg=?";
            ...
            else
            {
                if(sqlsrv_execute($stmt))
                {
                    while($row=sqlsrv_fetch_object($stmt))
                    {
                        ...
                        $res[]=array($row->worked, $row->bonus, $row->absent);
                    }
